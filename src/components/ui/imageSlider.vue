<template>
  ...
  >
    ...
    <div class="relative z-10 text-white p-8">
      <h1 class="text-4xl font-bold">{{ slides[currentSlide].title }}</h1>
      <p class="mt-4 text-lg">{{ slides[currentSlide].description }}</p>
      <button
        class="mt-6 px-6 py-2 bg-main text-white rounded-md shadow-lg"
...
const slides = ref([
  ...
  },
  {
    ...
    description: 'Join our community and stay updated with the latest news.',
    buttonText: 'Join Us',
    buttonLink: '/join'
  },
]);
