<template>
    <div class="flex justify-center items-center w-full h-[90vh] pt-32 lg:pb-5 lg:pt-12 mb:py-12 px-4">
        ...
        <div
            class="rounded-lg shadow-lg  flex flex-col lg:flex-row lg:mx-10 w-full p-6 sm:p-10 md:p-12 lg:p-20 justify-between items-center lg:items-start bg-white overflow-hidden">
